...
fn i32_load_8_s(
    ...
    builder.allocs.operands.push(Some(ValType::I32));
    instructions.push(Instruction::I32Load8_S(memarg));
    Ok(())
}
...
fn i32_load_8_u(
    ...
    let memarg = mem_arg(u, module, builder, &[0])?;
    builder.allocs.operands.push(Some(ValType::I32));
    instructions.push(Instruction::I32Load8_U(memarg));
    Ok(())
}
...
fn i32_load_16_s(
    ...
    builder.allocs.operands.push(Some(ValType::I32));
    instructions.push(Instruction::I32Load16_S(memarg));
    Ok(())
}
...
fn i32_load_16_u(
    ...
    let memarg = mem_arg(u, module, builder, &[0, 1])?;
    builder.allocs.operands.push(Some(ValType::I32));
    instructions.push(Instruction::I32Load16_U(memarg));
    Ok(())
}
...
fn i64_load_8_s(
    ...
    let memarg = mem_arg(u, module, builder, &[0])?;
    builder.allocs.operands.push(Some(ValType::I64));
    instructions.push(Instruction::I64Load8_S(memarg));
    Ok(())
}
...
fn i64_load_16_s(
    ...
    let memarg = mem_arg(u, module, builder, &[0, 1])?;
    builder.allocs.operands.push(Some(ValType::I64));
    instructions.push(Instruction::I64Load16_S(memarg));
    Ok(())
}
...
fn i64_load_32_s(
    ...
    let memarg = mem_arg(u, module, builder, &[0, 1, 2])?;
    builder.allocs.operands.push(Some(ValType::I64));
    instructions.push(Instruction::I64Load32_S(memarg));
    Ok(())
}
...
fn i64_load_8_u(
    ...
    let memarg = mem_arg(u, module, builder, &[0])?;
    builder.allocs.operands.push(Some(ValType::I64));
    instructions.push(Instruction::I64Load8_U(memarg));
    Ok(())
}
...
fn i64_load_16_u(
    ...
    let memarg = mem_arg(u, module, builder, &[0, 1])?;
    builder.allocs.operands.push(Some(ValType::I64));
    instructions.push(Instruction::I64Load16_U(memarg));
    Ok(())
}
...
fn i64_load_32_u(
    ...
    let memarg = mem_arg(u, module, builder, &[0, 1, 2])?;
    builder.allocs.operands.push(Some(ValType::I64));
    instructions.push(Instruction::I64Load32_U(memarg));
    Ok(())
}
...
fn memory_init(
    ...
    builder.pop_operands(&[ty]);
    instructions.push(Instruction::MemoryInit { mem, data });
    Ok(())
}
...
fn memory_copy(
    ...
    instructions.push(Instruction::MemoryCopy { dst, src });
    Ok(())
}
...
fn table_get(
    ...
    builder.push_operands(&[ty]);
    instructions.push(Instruction::TableGet { table: idx as u32 });
    Ok(())
}
...
fn table_copy(
    ...
    instructions.push(Instruction::TableCopy { src, dst });
    Ok(())
}
